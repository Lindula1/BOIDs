...
#         self.boid_list = None
#
#         self.max_groups = 25 # Must be a square number
#
...
#
#         height, width = v_abs[1] - v_abs[0], h_abs[1] - h_abs[0]
#         if not height == width:
#             raise Exception("Margin must be a square.")
#
#         return None
#
...
#         height, width = v_abs[1] - v_abs[0], h_abs[1] - h_abs[0]
#         if not height == width:
#             raise Exception("Border must be a square.")
#
